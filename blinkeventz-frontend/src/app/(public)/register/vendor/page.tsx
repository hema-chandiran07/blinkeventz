...
import { Eye, EyeOff, Mail, Lock, User as UserIcon, Loader2, CheckCircle2, ArrowLeft, Store } from "lucide-react";
...
export default function CustomerRegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      // Step 1: Register vendor (creates account, requires OTP verification)
        ...
        {step === 'register' ? (
          <Card className="border-0 shadow-2xl bg-white/90 backdrop-blur-sm">
            <CardHeader className="text-center pb-2">
              <div className="inline-flex h-16 w-16 rounded-2xl bg-purple-50 items-center justify-center mx-auto mb-4">
            ...
            <CardFooter className="flex flex-col space-y-3 text-center border-t pt-6">
              <div className="flex items-center gap-2 text-xs text-neutral-600">
                ...
                <span>Start accepting bookings today</span>
              </div>
