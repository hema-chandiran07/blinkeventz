...
export function AvailabilityCalendar({
  ...
  return (
    <Card className={cn("border-silver-100 shadow-lg", className)}>
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <Button variant="ghost" size="icon" onClick={handlePrevMonth} className="h-8 w-8 hover:bg-silver-50">
              <ChevronLeft className="h-4 w-4" />
            </Button>
            <span className="text-sm font-medium min-w-[140px] text-center">
              {monthNames[currentMonth.getMonth()]} {currentMonth.getFullYear()}
            </span>
            <Button variant="ghost" size="icon" onClick={handleNextMonth} className="h-8 w-8 hover:bg-silver-50">
        ...
        <div className="flex flex-wrap gap-3 mt-3">
          ...
          <div className="flex items-center gap-1.5">
            <div className="w-3 h-3 rounded-full bg-neutral-500 ring-2 ring-silver-200" />
      ...
      <CardContent className="space-y-4">
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  !isCurrentMonth && "bg-silver-50 text-neutral-400",
                  isCurrentMonth && !isPast && "hover:border-silver-300 hover:shadow-md cursor-pointer",
                  isPast && "opacity-40 cursor-not-allowed bg-silver-50",
                  isSelected && "ring-2 ring-neutral-500 border-neutral-500 bg-silver-50",
                  isToday && !isSelected && "border-silver-300 bg-silver-50/50",
        ...
        {selectedDate && (
          <div className="space-y-3 pt-4 border-t border-silver-100">
            <div className="flex items-center gap-2">
              <Clock className="h-4 w-4 text-neutral-600" />
              <h4 className="text-sm font-semibold text-black">Available Time Slots</h4>
            </div>
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isDisabled && "opacity-50 cursor-not-allowed bg-silver-100",
                        !isDisabled && !isSlotSelected && "hover:border-silver-300 hover:bg-silver-50 cursor-pointer",
                        isSlotSelected && "border-neutral-500 bg-silver-50 ring-2 ring-silver-200"
                      )}
                    >
                      <div className="flex items-center justify-between mb-1">
                        <span className={cn(
                          "text-xs font-semibold",
                          isSlotSelected ? "text-neutral-700" : "text-neutral-700"
                        )}>
                          {slot.label}
                        </span>
                        {slot.available ? (
                      ...
                      <div className="text-xs text-neutral-500 mb-1.5">{slot.time}</div>
                      <div className="flex items-center justify-between">
                        <span className={cn(
                          "text-sm font-bold",
                          isSlotSelected ? "text-neutral-800" : "text-neutral-600"
                        )}>
        ...
        {selectedDate && selectedSlot && (
          <div className="p-4 bg-gradient-to-r from-silver-50 to-silver-100 rounded-xl border border-silver-200">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="text-sm font-semibold text-black mb-1">Selected Date & Time</h4>
